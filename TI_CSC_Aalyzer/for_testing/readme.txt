...
================================
-TI_CSC_Aalyzer 
-run_TI_CSC_Aalyzer.sh (shell script for temporarily setting environment variables and 
                        executing the application)
   -to run the shell script, type
   
       ./run_TI_CSC_Aalyzer.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2024a, run the shell script as:
       ...
       ./run_TI_CSC_Aalyzer.sh /mathworks/home/application/R2024a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_TI_CSC_Aalyzer.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2024a/runtime/glnxa64:MR/R2024a/bin/glnxa64:MR/R2024a/sys/os/glnxa64:MR/R2024a/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_TI_CSC_Aalyzer.sh 
